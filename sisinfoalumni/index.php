	...
	<h2 class="loadtext2">Too slow? <a class="linkusual" href="basic.php">Load the basic!</a></h2>
		...
		<!-- Banner -->
			<section class="banner full">
				<article>
					<img src="images/1.jpg" alt="gambarmhs" />
					<div class="inner">
				...
				<article>
					<img src="images/p2.jpg" alt="batamviews" />
					<div class="inner">
						<header>
							<h2 style="font-size:50px">Sistem Informasi Alumni</h2>
						</header>
				...
				<article>
					<img src="images/p5.jpg"  alt="batamviews" />
					<div class="inner">
						<header>
							<h2 style="font-size:50px">Sistem Informasi Alumni</h2>
						</header>
				...
				<article>
					<img src="images/p4.jpg"  alt="batamviews" />
					<div class="inner">
						<header>
							<h2 style="font-size:50px">Sistem Informasi Alumni</h2>
						</header>
				...
				<div class="inner">
					<div class="grid-style">
						...
						<div>
							<div class="box">
								<div class="image fit">
									<img src="images/paskib.jpeg" style="height:450px;" alt="" />
								</div>
								<div class="content">
									...
									<p>Paskibraka adalah singkatan dari Pasukan Pengibar Bendera Pusaka dengan tugas utamanya untuk mengibarkan dan menurunkan Bendera Pusaka (kini duplikat) dalam upacara peringatan Hari Kemerdekaan Republik Indonesia dan Proklamasi Kemerdekaan Republik Indonesia di tiga tempat, yakni tingkat kabupaten/kota, provinsi, dan nasional. Anggotanya berasal dari pelajar SMA/sederajat kelas 10 dan/atau 11.</p>
									<footer class="align-center">
										<a target="_blank" href="https://id.wikipedia.org/wiki/Paskibraka" class="button alt">Lebih Lengkap</a>
									</footer>
								</div>
							</div>
						</div>
		...
		<!-- Footer -->
			<footer id="footer">
				...
				<div class="copyright">
					Copyright &#169; <script type='text/javascript'>var creditsyear = new Date();document.write(creditsyear.getFullYear());</script> <a expr:href='data:blog.homepageUrl'><data:blog.title/></a>. All rights reserved. | Repost by <a href='https://sharecodingan.blogspot.com/' title='sharecodingan.blogspot.com' target='_blank'>Irdan Firmansyah</a>
