	...
	<div class="container-contact100">
		<div class="wrap-contact100">
			<form class="contact100-form validate-form" enctype="multipart/form-data" method="POST" action="proses_tambah.php">
				...
				<div class="wrap-input100 validate-input" data-validate="Masukkan nama Sekolah!">
                    <span class="label-input100">Asal Sekolah</span>
                    <input class="input100" type="text" name="namaperusahaan" placeholder="Masukkan nama Sekolah!">
					<span class="focus-input100"></span>
				</div>
				...
				<div class="wrap-input100 validate-input" data-validate="Masukkan Tahun Gabung!">
				...
				<div class="container-contact100-form-btn">
					<div class="wrap-contact100-form-btn">
						<div class="contact100-form-bgbtn"></div>
				<a href="../index.php" class="contact100-form-btn">Back</a>
				</div>
				</div>
			</form>
		</div>
