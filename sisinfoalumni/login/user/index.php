    ...
    <header>
        ...
        <div class="navbar navbar-dark bg-dark box-shadow">
            <div class="container d-flex justify-content-between">
                <a href="galeri.php" class="navbar-brand d-flex align-items-center">
                    ...
                    <strong>Dokumentasi Informasi Paskibra SMKN 1 KATAPANG</strong>
                </a>
    ...
    <main role="main">
        ...
        <section class="jumbotron text-center">
            <div class="container">
                ...
                <p class="lead text-muted">Menampilkan Data Paskibra <strong>SMKN 1 KATAPANG</strong></p>
            </div>
        </section>
                        ...
                        <div class="card mb-4 box-shadow">
                            ...
                            <center>
                                <img class="card-img-top" style="width:200px;height:220px;"
                                    src="../admin/crud/gambar/<?php echo $row['gambar']; ?>" alt="Card image cap">
                            </center>
                            <?php } ?>
                            <div class="card-body">
                                <p class="card-text">Nama: <?php echo $row['nama']; ?></p>
                                <p class="card-text">Jenis Kelamin: <?php echo $row['jenis_kelamin']; ?></p>
                                <p class="card-text">Asal Sekolah: <?php echo $row['nama_perusahaan']; ?></p>
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    <div class="btn-group">
                                        <?php
                                            if ($row['gambar'] != "") { ?>
                                        <a type="button" href="../admin/crud/lihat.php?id=<?php echo $row['id']; ?>"
                                        ...
                                        <div class="dropdown-menu">
                                            <a class="dropdown-item"
                                                href="profile/createdata/kerja/reqedit.php?id=<?php echo $row['id']; ?>">Suggest
                                                Edit</a>
                                            <a class="dropdown-item" href="deleteitems.php?from=index.php">Request
                                                Delete Data</a>
                                        </div>
                                    </div>
                                </div>
