...
<body>
    <nav class="navbar navbar-dark bg-dark">
        <ul class="nav">
            <li class="nav-item">
                <a href="../../index.php" class="nav-link"> <button class="btn btn-primary"> Back to Home</button></a>
            </li>
        </ul>
    </nav>
                ...
                <form class="form-inline" method="GET">
                    <div class="selectdiv" style="width:165px">
                        <select name="kategori">
                            <option input type = "disabled" value="all">All</option>
                            <option value="kerja">Anggota</option>
                         
                            <option value="kerjakuliah">Alumni</option>
